...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { active: @buyer.active, email: @buyer.email, name: @buyer.name, phone_number: @buyer.phone_number, working_days: @buyer.working_days } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { active: @buyer.active, email: @buyer.email, name: @buyer.name, phone_number: @buyer.phone_number, working_days: @buyer.working_days } }
